...
// INSTRUCCIONES:
// 1. Copia este archivo como 'firebase-config-real.js'
// 2. Reemplaza los valores de ejemplo con tu configuración real de Firebase
// 3. NO subas 'firebase-config-real.js' a GitHub (ya está en .gitignore)
...
// Instancia global
window.firebaseReal = new FirebaseRealConfig();
